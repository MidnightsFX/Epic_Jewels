...
A compressed file with the binaries is created in `<EpicJewels>\Packages`ready for upload to ThunderStore.
...
A Unity project is included in this repository under `<EpicJewels>\JotunnModUnity`.
...
4. Compile the project. This copies all assemblies into `<EpicJewels>\JotunnModUnity\Assets\Assemblies`. Don't open Unity yet before this step, it will remove assembly references.
