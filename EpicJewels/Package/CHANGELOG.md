 ...
 **1.0.0**
 ---
 ```
- Update to support Jewelcrafting 2.0
- Crystal colors have been updated
- Updated localizations for some effects
- Jotunn now required
- Yaml.net now required
- Adds full integration to support Crystal Lights
	- Light variants of all crystals added by Epic Jewels are now available (Thanks Gravebear!)
- Tooltip display for damage effects fixed
- Adds Adrenaline gem effects for all EJ gems
	- Jade: Toxifier - Gain adrenaline from poison around you.
	- Amber: Adrenal Rewire - Gain adrenaline from damage taken.
	- Aquamarine: Soaked Fury - Gain additional adrenaline while wet.
	- Garnet: Burning Adrenaline - Gain additional adrenaline while on fire.
	- Opal: Harvest Adrenaline - Chance to gain adrenaline from harvesting.
	- Amethyst: Eitr Feedback - Chance to restore adrenaline from eitr use.
 ``` 

 **0.9.25**
 ---
 ```
 - Compatability improvement for WackyMMO Damage attribution from Retribution, FreezingGuard, and FlamingGuard
 - Improved damage number location for Retribution, FreezingGuard, and FlamingGuard
 ``` 
