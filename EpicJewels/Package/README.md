...
[![discord logo](https://i.imgur.com/uE6umQE.png)](https://discord.gg/Dmr9PQTy9m) [![github logo](https://i.imgur.com/lvbP5OF.png)](https://github.com/MidnightsFX/epic_jewels_jotunn)
...
All of the effects can be modified using Jewelcraftings yaml configuration. The default configuration for all of the effects can be found [here](https://github.com/MidnightsFX/epic_jewels_jotunn/blob/master/EpicJewels/AssetsEmbedded/EJConfig.yaml).
...
|Trinket| Toxifier| Gain adrenaline from poison around you.|
...
|Trinket|Adrenal Rewire| Gain adrenaline from damage taken.|
...
|Trinket| Soaked Fury| Gain additional adrenaline while wet.|
...
|Trinket| Burning Adrenaline| Gain additional adrenaline while on fire.|
...
|Trinket| Harvest Adrenaline | Chance to gain adrenaline from harvesting.|
...
|Trinket|Eitr Feedback|Chance to restore adrenaline from eitr use.|
...
eg: `EpicJewels.English.json`. Existing translations can be found on [github](https://github.com/MidnightsFX/epic_jewels_jotunn/tree/master/EpicJewels/translations).
