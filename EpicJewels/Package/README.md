...
All of the effects can be modified using Jewelcraftings yaml configuration. The default configuration for all of the effects can be found [here](https://github.com/MidnightsFX/Jewelcrafting_Epic_Jewels/blob/master/EpicJewels/AssetsEmbedded/EJConfig.yaml).
